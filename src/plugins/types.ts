...
// system_prompt_tools_filter hook
export type PluginHookSystemPromptToolsFilterEvent = {
  tools: PluginHookToolEntry[];
};

export type PluginHookSystemPromptToolsFilterResult = {
  tools: PluginHookToolEntry[];
};

// system_prompt_skills_filter hook
export type PluginHookSystemPromptSkillsFilterEvent = {
  skillsPrompt: string;
};

export type PluginHookSystemPromptSkillsFilterResult = {
  skillsPrompt: string;
};

// system_prompt_footer hook
export type PluginHookSystemPromptFooterEvent = {
  currentPrompt: string;
};

export type PluginHookSystemPromptFooterResult = {
  append: string;
};

// workspace_bootstrap_before hook
export type PluginHookBootstrapFile = {
  name: string;
  content: string;
};

export type PluginHookWorkspaceBootstrapBeforeEvent = {
  workspaceDir: string;
  files: PluginHookBootstrapFile[];
  isNewWorkspace: boolean;
};

export type PluginHookWorkspaceBootstrapBeforeResult = {
  files: PluginHookBootstrapFile[];
  skip: boolean;
};

// workspace_bootstrap_after hook (fire-and-forget)
export type PluginHookWorkspaceBootstrapAfterEvent = {
  workspaceDir: string;
  filesWritten: string[];
  filesSkipped: string[];
};

// subagent_prompt_validate hook
export type PluginHookSubagentPromptValidateEvent = {
  agentId: string;
...
export type PluginHookSubagentPromptValidateResult = {
  block: boolean;
  reason?: string;
};
...
export type PluginHookHandlerMap = {
  ...
  system_prompt_tools_filter: (
    ...
    | Promise<PluginHookSystemPromptToolsFilterResult | void>
  ...
  system_prompt_skills_filter: (
    ...
    | Promise<PluginHookSystemPromptSkillsFilterResult | void>
  ...
  system_prompt_footer: (
    ...
    | Promise<PluginHookSystemPromptFooterResult | void>
  ...
  workspace_bootstrap_before: (
    ...
    | Promise<PluginHookWorkspaceBootstrapBeforeResult | void>
